...
| `feedback command` | Digest continuation shorthand: `dig:` for deep analysis, `track:` for thread updates, and plain-language feedback for durable preference updates. |
...
flowchart TD
  ...
  DigestItem --> Feedback["dig/track/plain feedback"]
  Feedback --> Request
  Feedback --> ThreadSeed
```
