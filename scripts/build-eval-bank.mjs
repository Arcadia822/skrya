...
const extras = [
  ...
  ["11", "5", "runtime-required", "试跑输出的 ## 系统提示 应该解释 A 2 指令。请给出正确行为。", ["The response explains that A 2 means deep analysis of item 2.", "The explanation is in user-readable Chinese.", "The section also mentions scan range and available follow-up operations.", "The section does not expose internal debug fields."]],
