...
Injected into a `workspace` coding session for small, bounded work in this repository.

## Working Rules

1. Read `AGENTS.md` and the relevant local docs before editing.
2. If the task changes skill behavior, edit `skills-src/` and `prompt-templates/`, not the generated copies under `skills`.
