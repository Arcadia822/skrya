...
Injected into a `workspace` coding session for substantial work in this repository.

## Full Pipeline

1. Read `AGENTS.md`, `README.md`, `design/current-system-design.md`, and `design/core-skills-spec.md`.
